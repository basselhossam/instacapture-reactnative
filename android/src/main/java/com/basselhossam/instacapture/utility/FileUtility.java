package com.basselhossam.instacapture.utility;
...
/**
 * Created by basselhossam on 5/5/2018.
 */

public class FileUtility {

    private static final String SCREENSHOTS_DIRECTORY_NAME = "screenshots";
    private static int JPEG_COMPRESSION_QUALITY = 75;
    private static final String TAG = "BasselInstaCapture";
    ...
    public static void setJpegCompressionQuality(int quality){
        JPEG_COMPRESSION_QUALITY = quality;
    }

    public static String getScreenshotsDirectoryName(Context context){
        return context.getFilesDir() + "/" + SCREENSHOTS_DIRECTORY_NAME;
    }
}
